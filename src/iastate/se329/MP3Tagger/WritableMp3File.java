...
public class WritableMp3File extends Mp3File {
	 ...
	 * @param arg0 The mp3 file path.
	 * @throws IOException Thrown if the specified file does not exist.
	 * @throws UnsupportedTagException Thrown if any required tags are missing.
	 * @throws InvalidDataException Thrown if the specified file is not a proper mp3 file.
	 */
	...
	/**
	 * Creates a WritableMp3File object for an mp3 file designated by arg0 with a buffer size of arg1.
	 * @param arg0 The mp3 file path.
	 * @param arg1 The length of the buffer.
	 * @throws IOException Thrown if the specified file does not exist.
	 * @throws UnsupportedTagException Thrown if any required tags are missing.
	 * @throws InvalidDataException Thrown if the specified file is not a proper mp3 file.
	 */
	 ...
	 * Creates a WritableMp3File object for an mp3 file designated by arg0.
	 * @param arg0 The mp3 file path.
	 * @param arg1 Boolean to determine if the file should be scanned.
	 * @throws IOException Thrown if the specified file does not exist.
	 * @throws UnsupportedTagException Thrown if any required tags are missing.
	 * @throws InvalidDataException Thrown if the specified file is not a proper mp3 file.
	 */
	 ...
	 * @param arg0 The mp3 file path.
	 * @param arg1 The length of the buffer.
	 * @param arg2 Boolean to determine if the file should be scanned.
	 * @throws IOException Thrown if the specified file does not exist.
	 * @throws UnsupportedTagException Thrown if any required tags are missing.
	 * @throws InvalidDataException Thrown if the specified file is not a proper mp3 file.
	 */
	...
	/**
	 * Reads the tags on the MP3 to provide the information specified on the pattern string.
	 ...
	 * The following symbols will be removed from the path after
	 * the appropriate tag information has been added:<br>[ : \\ * ? \" | < > ]<br>
	 * @param pattern The pattern of the requested information.
	 * @return The information contained within the tags of the MP3.
	 * @throws TagException Thrown if a tag is not provided.
	 */
